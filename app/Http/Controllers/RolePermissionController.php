...
class RolePermissionController extends Controller
{
    ...
    public function index($roleId)
    {
        ...
        $rolePermissions = ModelsRole::findOrFail($roleId)->permissions;
        ...
        return response()->view(
            'dashbord.Spatiy.Role.role-permission',
    ...
    public function store(Request $request, $roleId)
    {
        ...
        if (!$validator->fails()) {
            ...
            $permission = ModelsPermission::findOrFail($request->get('permission_id'));
