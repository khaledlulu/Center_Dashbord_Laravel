...
<div class="col-md-12">
    ...
    <div class="card card-success">
      ...
      <form >
        ...
        <div class="row">
            ...
            aria-label=".form-select-sm example">
            <option selected>{{ $admins->user->currancy }}</option>
    ...
    <div class="row">
        ...
        <div class="card-footer">
          <a href="#" onclick="preformstore({{ $admins->id }})" type="button" class="btn btn-success col-1">Update</a>
          @can('Edit-Admin')
...
<script>
    function preformstore(id){
        ...
        storeRoute('/dashbord/update_admins/'+id,formData)
    }
</script>
@endsection
