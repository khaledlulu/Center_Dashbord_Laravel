...
@section('MainTitle','Edit Employee')
...
<div class="col-md-12">
    ...
    <div class="card card-success">
      ...
      <form >
        ...
        <div class="row">
            ...
            aria-label=".form-select-sm example">
            <option selected>{{ $employees->user->currancy }}</option>
    ...
    <a href="#" onclick="preformstore({{ $employees->id }})" type="button" class="btn btn-success col-1">Update</a>
        @can('Edit-Employee')
...
<script>
    function preformstore(id){
        ...
        storeRoute('/dashbord/update_employees/'+id,formData)
    }
</script>
@endsection
