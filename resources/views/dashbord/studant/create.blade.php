...
@section('Title','Create Studant')
@section('styles')

@endsection

@section('MainTitle','Create Studant')
@section('subtitle','create studant')
...
<div class="col-md-12">
    ...
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">Creat Studant</h3>
      </div>
...
<script>
    function preformstore(){
        ...
        store('/dashbord/studants',formData)
    }
</script>
@endsection
